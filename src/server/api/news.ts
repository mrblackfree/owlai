...
handler.get('/', async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: 'Failed to fetch news posts', details: error.message });
  }
});
...
handler.get('/:slug', async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: 'Failed to fetch news post', details: error.message });
  }
});
...
handler.post('/', async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: 'Failed to create news post', details: error.message });
  }
});
...
handler.patch('/:id', async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: 'Failed to update news post', details: error.message });
  }
});
...
handler.delete('/:id', async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: 'Failed to delete news post', details: error.message });
  }
});
...
handler.post('/:id/share', async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: 'Failed to increment shares', details: error.message });
  }
});
